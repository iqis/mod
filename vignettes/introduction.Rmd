...
It is imperative that `mod` be only adopted in simple cases. If full-featured OOP is desired, use [`R6`](https://CRAN.R-project.org/package=R6). The user is reminded that OOP, in general, should be used sparingly and with deliberation.
